...
module.exports = function(self, options) {
  ...
  self.createRoutes = function() {
    ...
    self.route('post', 'delete-from-trash', self.routes.deleteFromTrash);
  };
  ...
  self.routes.deleteFromTrash = function(req, res) {
    if (req.body.job) {
      return self.apos.modules['apostrophe-jobs'].run(req, self.apos.attachments.deleteFromTrash, {labels: {title: 'Delete From Trash'}});
    }
  }
};
